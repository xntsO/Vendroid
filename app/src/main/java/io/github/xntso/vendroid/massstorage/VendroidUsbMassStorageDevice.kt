...
import io.github.xntso.vendroid.utils.ktexts.name
import io.github.xntso.vendroid.utils.ktexts.vidpid
...
data class UsbMassStorageDeviceDescriptor(
    ...
    fun buildDevice(context: Context): VendroidUsbMassStorageDevice =
        buildDevice(context.getSystemService(Context.USB_SERVICE) as UsbManager)

    fun buildDevice(usbManager: UsbManager): VendroidUsbMassStorageDevice {
        return VendroidUsbMassStorageDevice(
            usbManager,
            maybeUsbDevice!!,
            usbInterface!!,
            inEndpoint!!,
...
class VendroidUsbMassStorageDevice
internal constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun getMassStorageDevices(context: Context): Array<VendroidUsbMassStorageDevice> {
